...
interface ConnectUsMobileProps {
...
const ConnectUsMobile: React.FC<ConnectUsMobileProps> = ({
  data: id,
  subDomain,
}) => {
  ...
  return (
    <section className="catalog-pg-mobile-connect-us-root">
      <div className="catalog-pg-mobile-connect-us-header">
        <h3 className="catalog-pg-mobile-connect-us-title">
          {t("enquirySection.title")}
        </h3>
      </div>

      <form
        className="catalog-pg-mobile-connect-us-form"
        onSubmit={handleSubmit(onSubmit)}
        noValidate
      >
        {/* Name Field */}
        <div className="catalog-pg-mobile-form-group">
          <label className="catalog-pg-mobile-form-label">
          ...
          {errors.supplierName?.message && (
            <span className="catalog-pg-mobile-error-text">
              {errors.supplierName.message}
            </span>
          )}
        </div>
            ...
            render={({ field }) => {
              ...
              return (
                <>
                  ...
                  />
                  <div
                    className="catalog-pg-mobile-char-limit"
                    aria-live="polite"
                  >
        ...
        {/* Submit Button */}
        <div className="catalog-pg-mobile-form-actions">
          <Button
            type="submit"
            className="catalog-pg-mobile-submit-btn"
            text={
              isFormSubmitting
...
export default ConnectUsMobile;
