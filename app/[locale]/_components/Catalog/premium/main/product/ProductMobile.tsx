...
const ROW_LIMIT = 10;
const SUBDOMAIN = "dev-international"; // <-- consider passing as prop if needed
...
const ProductMobile: React.FC = () => {
  ...
  return (
    <div className="catalog-pg-mobile-product-root">
      <div className="catalog-pg-mobile-product-header">
        {" "}
        <h5 className="catalog-pg-mobile-product-title">Products</h5>
      </div>

      {/* Products */}
      <div className="catalog-pg-mobile-product-grid">
      ...
      {!isProductsFetching && hasMoreProducts && !isLoadingMore && (
        <div className="catalog-pg-mobile-product-load-more" onClick={loadMore}>
